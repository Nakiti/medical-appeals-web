...
import { User, FileText, Shield, Stethoscope, UploadCloud } from 'lucide-react';
import { FormContext } from "@/app/context/formContext";
import FileUploadSection from "../components/fileUploadSection";
import { useRef } from "react";

const DetailsLayout = ({ params, children }) => {
  // The `use` hook is for resolving promises, often used in Server Components.
  // For a client component, you'd typically get params via props or a hook like `useParams` from `next/navigation`.
  // We'll assume `params` is passed as a prop for this client component.
