...
import { User, FileText, Shield, Stethoscope, UploadCloud, Sparkles, ChevronUp, ChevronDown, Trash2 } from 'lucide-react';
...
const FileUploadSection = () => {
  ...
  const isParseDisabled = isParsing || !hasUnparsedFiles || documents.length === 0;
