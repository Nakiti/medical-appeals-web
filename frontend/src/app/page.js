      ...
      <div className="bg-gray-100 min-h-screen">
         ...
         <header className="bg-white text-gray-800 border-b border-gray-300 py-2">
            ...
            <div className="space-x-4">
               {!currentUser ? <Link href="/login" className="px-4 py-2 rounded bg-white text-gray-800 text-sm border border-gray-300 hover:bg-gray-100">
                  Log In
               </Link> : <Link className="px-4 py-2 rounded bg-white text-gray-800 text-sm border border-gray-300 hover:bg-gray-100" href="/user/dashboard/home">
                     Home
                  </Link>}
            </div>
            </nav>
         ...
         <section className="relative bg-gray-300 text-gray-900 flex items-center justify-center" style={{ height: "500px" }}>
            ...
            <div className="relative text-center">
               ...
               <div className="mt-12">
                  <Link href="/appeal/new/claim-number" className="px-6 py-3 bg-gray-100 text-gray-800 rounded font-semibold hover:bg-gray-300">
                     Get Started
                  </Link>
               </div>
            </div>
