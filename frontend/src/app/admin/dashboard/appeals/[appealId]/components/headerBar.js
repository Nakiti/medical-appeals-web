...
const HeaderBar = ({ appealId, links, back }) => {
  ...
  return (
   <div className="bg-gradient-to-r from-slate-600 to-slate-800 to-slate-600 px-6 pt-6 border-b border-slate-600 text-white">
   {appeal && (
      <div className="space-y-6 max-w-7xl mx-auto">
         ...
         <div className="flex gap-6 pl-1 sm:pl-10 border-t border-slate-600 pt-4 overflow-x-auto mb-0">
